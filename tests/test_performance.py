...
class TestLargeDataProcessing:
    ...
    def test_data_aggregation_performance(self):
        ...
        daily_data = pd.DataFrame(
            {
                "stock_id": np.random.choice(
                    ["2330.TW", "2317.TW", "2454.TW"], n_records
                ),
    ...
    def test_memory_usage(self):
        ...
        ), f"記憶體使用 {memory_usage / 1024 / 1024:.2f} MB"
...
class TestScalability:
    ...
    def test_data_scaling(self):
        ...
        for i in range(1, len(times)):
            ...
            assert (
                ratio < size_ratio * 2
            ), f"擴展性不佳: 時間比率 {ratio:.2f}, 資料量比率 {size_ratio:.2f}"
    ...
    def test_stock_scaling(self):
        ...
        for i in range(1, len(times)):
            ...
            assert (
                ratio < stock_ratio * 2
            ), f"擴展性不佳: 時間比率 {ratio:.2f}, 股票數量比率 {stock_ratio:.2f}"
