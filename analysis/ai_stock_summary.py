...
class AIStockSummary:
    ...
    def generate_summary(
        self, universe: List[str] = None, top_n: int = 10, include_analysis: bool = True
    ) -> Dict:
        """
        生成 AI 選股摘要
        ...
        try:
            ...
            return {"success": True, "data": summary_report}
        ...
        try:
            ...
            if result.get("success"):
                ...
                return {
                    ...
                    "regime_name": "未知",
                    "confidence": 0,
                    "suggestion": {"action": "觀望", "reason": "無法判斷市場狀態"},
                }
        except Exception as e:
            ...
            return {
                ...
                "regime_name": "未知",
                "confidence": 0,
                "suggestion": {"action": "觀望", "reason": "分析失敗"},
            }
    ...
    def _generate_investment_advice(
        ...
        try:
            ...
            # 產業建議
            strongest_industry = industry_analysis.get("summary", {}).get(
                "strongest_industry", "N/A"
            )
            weakest_industry = industry_analysis.get("summary", {}).get(
                "weakest_industry", "N/A"
            )

            # 概念股建議
            hottest_concept = concept_analysis.get("summary", {}).get(
                "hottest_concept", "N/A"
            )
            ...
            industry_allocation = {
                ...
                "allocation": {strongest_industry: 0.6, weakest_industry: 0.4},
            }
    ...
    def _generate_risk_warnings(
        self, market_analysis: Dict, screener_results: List
    ) -> List[str]:
        """生成風險提示"""
        try:
            warnings = []
            ...
            if len(screener_results) > 0:
                ...
                if top_stock.composite_score > 0.8:
                    warnings.append(
                        f"⚠️ {top_stock.stock_name} 分數過高，可能有過熱風險"
                    )
    ...
    def _generate_executive_summary(
        self, market_analysis: Dict, screener_results: List, investment_advice: Dict
    ) -> str:
        """生成執行摘要"""
        try:
            # 市場狀態
