...
class StockChatbot:
    ...
    def _detect_intent(self, message: str) -> str:
        ...
        # 建議相關
        elif any(word in message for word in ['建議', '買', '賣', '持有', '進場', '出場']):
        ...
        # 估值相關
        elif any(word in message for word in ['估值', 'pe', 'pb', '本益比', '淨值比', '便宜', '貴']):
            return "valuation"
    ...
    async def _analysis_response(self, stock_id: str) -> Dict:
        ...
        try:
            ...
            action_text = {"buy": "買入", "sell": "賣出", "hold": "持有"}.get(action, "觀望")
    ...
    async def _valuation_response(self, stock_id: str) -> Dict:
        ...
        try:
            ...
            message += f"• EV/EBITDA：{data.get('ev_ebitda', {}).get('ev_ebitda', 'N/A')}\n"
    ...
    async def _trend_response(self, stock_id: str) -> Dict:
        ...
        try:
            ...
            message += "**趨勢方向：**\n"
            message += f"• 短期（5天）：{self._trend_emoji(short)} {self._trend_text(short)}\n"
    ...
    async def _prediction_response(self, stock_id: str) -> Dict:
        ...
        try:
            ...
            message += f"**預測趨勢：** {self._trend_emoji(trend)} {self._trend_text(trend)}\n"
