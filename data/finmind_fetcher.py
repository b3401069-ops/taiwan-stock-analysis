...
class FinMindFetcher:
    ...
    def _make_request(self, dataset: str, data_id: str, 
    ...
    def get_stock_price(self, stock_id: str, start_date: str = "", 
                        end_date: str = "") -> Dict:
        """
        取得股票日K線資料
    ...
    def get_institutional_investors(self, stock_id: str, start_date: str = "",
                                    end_date: str = "") -> Dict:
        """
        取得三大法人買賣超資料
    ...
    def get_margin_trading(self, stock_id: str, start_date: str = "",
                           end_date: str = "") -> Dict:
        """
        取得融資融券資料
    ...
    def get_monthly_revenue(self, stock_id: str, start_date: str = "",
                            end_date: str = "") -> Dict:
        """
        取得月營收資料
    ...
    def get_dividend(self, stock_id: str, start_date: str = "",
                     end_date: str = "") -> Dict:
        """
        取得股利資料
    ...
    def get_financial_statements(self, stock_id: str, start_date: str = "",
                                 end_date: str = "") -> Dict:
        """
        取得財務報表
    ...
    def get_balance_sheet(self, stock_id: str, start_date: str = "",
                          end_date: str = "") -> Dict:
        """
        取得資產負債表
    ...
    def get_cash_flows(self, stock_id: str, start_date: str = "",
                       end_date: str = "") -> Dict:
        """
        取得現金流量表
    ...
    def get_all_data(self, stock_id: str, start_date: str = "",
                     end_date: str = "") -> Dict:
        """
        取得所有資料（一次性）
        ...
        results["institutional"] = self.get_institutional_investors(stock_id, start_date, end_date)
        ...
        results["financial"] = self.get_financial_statements(stock_id, start_date, end_date)
        results["balance_sheet"] = self.get_balance_sheet(stock_id, start_date, end_date)
