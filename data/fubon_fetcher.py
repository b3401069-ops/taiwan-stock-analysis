...
class FubonFetcher:
    ...
    def __init__(
        self, api_key: str = None, api_secret: str = None, account: str = None
    ):
        """
        初始化富邦 SDK
        ...
        try:
            ...
            result = {
                ...
                "orderbook": {
                    "bid": [
                        {
                            "price": quote.get(f"bid_price_{i}", 0),
                            "volume": quote.get(f"bid_volume_{i}", 0),
                        }
                        for i in range(1, 6)
                    ],
                    "ask": [
                        {
                            "price": quote.get(f"ask_price_{i}", 0),
                            "volume": quote.get(f"ask_volume_{i}", 0),
                        }
                        for i in range(1, 6)
                    ],
                },
            ...
            return {
                "success": False,
                "error": str(e),
                "data": self._mock_realtime_quote(stock_id)["data"],
            }
    ...
    def get_historical_data(
        ...
        try:
            ...
            return {
                "success": False,
                "error": str(e),
                "data": self._mock_historical_data(stock_id)["data"],
            }
    ...
    def _mock_realtime_quote(self, stock_id: str) -> Dict:
        ...
        return {
            ...
            "data": {
                ...
                "orderbook": {
                    "bid": [
                        {"price": 999, "volume": 1000},
                        {"price": 998, "volume": 2000},
                    ],
                    "ask": [
                        {"price": 1001, "volume": 1500},
                        {"price": 1002, "volume": 2500},
                    ],
                },
                "source": "mock",
            },
    ...
    def _mock_historical_data(self, stock_id: str) -> Dict:
        ...
        return {
            "success": True,
            "data": {"stock_id": stock_id, "count": 0, "data": [], "source": "mock"},
        }
...
def get_fubon_fetcher(
    api_key: str = None, api_secret: str = None, account: str = None
) -> FubonFetcher:
    """取得 FubonFetcher 單例"""
